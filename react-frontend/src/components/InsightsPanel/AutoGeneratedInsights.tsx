    ...
    if (alignment?.coverageStats) {
      ...
      if (coverage < 80) {
        insights.push({
          ...
          description: `Only ${coverage.toFixed(1)}% of prompts have matching completions across all datasets. This may limit the reliability of comparative analysis.`,
    ...
    if (lengthMetrics.length > 0) {
      ...
      if (significantLengthDiffs.length > 0) {
        ...
        insights.push({
          ...
          description: `Dataset ${longerDataset} consistently generates ${longerDataset === 'A' ? 'longer' : 'shorter'} completions. Consider if this aligns with your requirements.`,
          impact: 'medium',
          icon: TrendingUp,
